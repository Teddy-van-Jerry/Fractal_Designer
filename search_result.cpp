...
void Search_Result::getSearch(QString search)
{
    ...
    All_P[13] = {13, "Install FFmpeg", "Check the installation of FFmpeg 4.3.1", {"install", "ffmpeg", "下载", "下载ffmpeg", "ffmpeg下载"}};
    All_P[14] = {14, "Log In", "Log in", {"log", "in", "登录"}};
    All_P[15] = {15, "Preview Settings", "Set preview image size, location and auto refresh.", {"auto", "refresh", "preview", "setting", "settings", "set", "自动", "刷新", "预览", "自动刷新", "自动刷新", "自动刷新预览图", "自动刷新预览图片", "预览刷新", "刷新预览", "预览图刷新", "刷新预览图", "预览图片刷新", "刷新预览图片", "设置", "预览设置", "设置预览", "预览图设置", "设置预览图", "预览", "预览图"}};
    ...
    All_P[19] = {19, "Reset Colour Definition", "Reset the colour defination to default.", {"colour", "color", "defination", "颜色", "重置颜色", "颜色设置", "重置颜色设置"}};
    All_P[20] = {20, "New Features", "View New Features in Fractal Designer since Version 5.0.", {"new", "feature", "features", "新特征", "新"}};
    ...
    for (auto result : All_P)
    {
        ...
        Btn_Con(10, on_actionPreview_Refresh_triggered());
