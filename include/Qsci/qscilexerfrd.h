// This defines the interface to the QsciLexerFRD class.
//
...
#ifndef QsciLexerFRD_H
#define QsciLexerFRD_H
...
//! lexer.
class QSCINTILLA_EXPORT QsciLexerFRD : public QsciLexer
{
    Q_OBJECT
...
public:
    ...
    QsciLexerFRD(QObject *parent = 0, bool caseInsensitiveKeywords = false);

    //! Destroys the QsciLexerFRD instance.
    virtual ~QsciLexerFRD();
