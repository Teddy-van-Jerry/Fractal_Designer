// This module implements the QsciLexerFRD class.
//
...
// The ctor.
QsciLexerFRD::QsciLexerFRD(QObject *parent, bool caseInsensitiveKeywords)
    : QsciLexer(parent),
...
// The dtor.
QsciLexerFRD::~QsciLexerFRD()
{
}


// Returns the language name.
const char *QsciLexerFRD::language() const
{
    return "FRD";
}
...
const char *QsciLexerFRD::lexer() const
{
...
// words.
QStringList QsciLexerFRD::autoCompletionWordSeparators() const
{
    QStringList wl;
...
const char *QsciLexerFRD::blockStartKeyword(int *style) const
{
    if (style)
        *style = Keyword;
...
const char *QsciLexerFRD::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
const char *QsciLexerFRD::blockEnd(int *style) const
{
    if (style)
        *style = Operator;
...
int QsciLexerFRD::braceStyle() const
{
    return Operator;
}
...
const char *QsciLexerFRD::wordCharacters() const
{
...
QColor QsciLexerFRD::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerFRD::defaultEolFill(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
QFont QsciLexerFRD::defaultFont(int style) const
{
    QFont f;
...
const char *QsciLexerFRD::keywords(int set) const
{
    if (set == 1)
        return
...
QString QsciLexerFRD::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor QsciLexerFRD::defaultPaper(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
void QsciLexerFRD::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool QsciLexerFRD::readProperties(QSettings &qs,const QString &prefix)
{
...
bool QsciLexerFRD::writeProperties(QSettings &qs,const QString &prefix) const
{
...
void QsciLexerFRD::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void QsciLexerFRD::setAtElseProp()
{
...
void QsciLexerFRD::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void QsciLexerFRD::setCommentProp()
{
...
void QsciLexerFRD::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void QsciLexerFRD::setCompactProp()
{
...
void QsciLexerFRD::setFoldPreprocessor(bool fold)
{
    fold_preproc = fold;
...
void QsciLexerFRD::setPreprocProp()
{
...
void QsciLexerFRD::setStylePreprocessor(bool style)
{
    style_preproc = style;
...
void QsciLexerFRD::setStylePreprocProp()
{
...
void QsciLexerFRD::setDollarsAllowed(bool allowed)
{
    dollars = allowed;
...
void QsciLexerFRD::setDollarsProp()
{
...
void QsciLexerFRD::setHighlightTripleQuotedStrings(bool enabled)
{
...
void QsciLexerFRD::setHighlightTripleProp()
{
...
void QsciLexerFRD::setHighlightHashQuotedStrings(bool enabled)
{
...
void QsciLexerFRD::setHighlightHashProp()
{
...
void QsciLexerFRD::setHighlightBackQuotedStrings(bool enabled)
{
...
void QsciLexerFRD::setHighlightBackProp()
{
...
void QsciLexerFRD::setHighlightEscapeSequences(bool enabled)
{
...
void QsciLexerFRD::setHighlightEscapeProp()
{
...
void QsciLexerFRD::setVerbatimStringEscapeSequencesAllowed(bool allowed)
{
    vs_escape = allowed;
...
void QsciLexerFRD::setVerbatimStringEscapeProp()
{
...
void QsciLexerFRD::styleText(int start, int end)
{

}

// Start styling.
void QsciLexerFRD::startStyling(int start, int)
{
    if (!editor())
        return;
...
void QsciLexerFRD::setStyling(int length, int style)
{
    if (!editor())
        return;
...
// Set the style for a number of characters.
void QsciLexerFRD::setStyling(int length, const QsciStyle &style)
{
...
void QsciLexerFRD::setEditor(QsciScintilla *new_editor)
{
    if (editor())
...
int QsciLexerFRD::styleBitsNeeded() const
{
    return 5;
}
...
void QsciLexerFRD::handleStyleNeeded(int pos)
{
